...
5. Restaurado `media_url` y `media_type` en el código (columnas SÍ existen)
6. Tipos TypeScript regenerados
7. Scroll automático implementado en ambos chats
8. Tipo Lead corregido para coincidir con estructura de BD
9. Casts de id a string agregados
10. mockData.ts corregido (countryCode → country_code)
11. Campos opcionales del tipo Lead marcados correctamente
12. Cast agregado para resolver incompatibilidad de tipo status
...
- [x] Restaurar media_url y media_type (columnas SÍ existen)
...
- [x] Reiniciar servidor (restart #149)
