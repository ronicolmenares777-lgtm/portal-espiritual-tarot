          ...
          <div className="bg-card/80 backdrop-blur-sm border-2 border-gold/30 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-primary/20 via-amber-500/20 to-primary/20 border-b-2 border-gold/20 p-3 sm:p-4 md:p-6 shadow-lg">
              <div className="flex items-center justify-between gap-2 sm:gap-4">
                ...
                {/* Botones de acción - WhatsApp y Cerrar Sesión */}
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <a
                    ...
                    className="px-2 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg sm:rounded-xl font-semibold transition-all shadow-lg flex items-center gap-1 sm:gap-2 text-xs sm:text-sm md:text-base"
                  >
                    <svg
                  ...
                  <button
                    ...
                    className="px-2 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2 bg-red-500/80 hover:bg-red-500 text-white rounded-lg sm:rounded-xl font-semibold transition-all shadow-lg flex items-center gap-1 sm:gap-2 text-xs sm:text-sm md:text-base"
                  >
                    <svg
                      className="w-4 h-4 sm:w-5 sm:h-5"
                      fill="none"
